...
\textbf{结果：}
\shot{第 14 题（a）Makefile 依赖与首次构建}{report_imgs/q14a.png}{0.72\textwidth}
\shot{第 14 题（b）增量构建与 clean 清理}{report_imgs/q14b.png}{0.72\textwidth}
...
\shot{实例 5（a）注入错误后门禁拦截推送}{report_imgs/n05a.png}{0.72\textwidth}
\shot{实例 5（b）修复后三级门禁通过}{report_imgs/n05b.png}{0.72\textwidth}
...
\shot{实例 9（a）构建失败拒绝提交}{report_imgs/n09a.png}{0.72\textwidth}
\shot{实例 9（b）修复后提交成功}{report_imgs/n09b.png}{0.72\textwidth}
